...
<main>
    ...
    <div class="home-title">
            <p><a href="Project1.php"> Home&nbsp;> </a>&nbsp;<b>Uni-Color Socks</b></p> 
    </div>
            ...
            <div class ="recommend-section">
                    ...
                    <div class="rec-h1-style"><h1> You might also like</h1></div>
                        ...
                        <div class="grid-items1 flex-element">
                            <div class="rec">
                                <a  href="./product_detail_strip.php" ><img class="rec-img pack-sock-blue" src="./img/packaging/png/catalogus_sokken_stripes_blue.png" alt="Blue packaged uni-color socks">
                        ...
                        <div class="grid-items2 flex-element">
                            <div class="rec">
                                <a  href="./product_detail_strip.php" ><img class="rec-img pack-sock-pink" src="./img/packaging/png/catalogus_sokken_stripes_pink.png" alt="Pink packaged uni-color socks">
                        ...
                        <div class="grid-items3 flex-element">
                            <div class="rec">
                                <a  href="./product_detail_strip.php" ><img class="rec-img pack-sock-green" src="./img/packaging/png/catalogus_sokken_stripes_green.png" alt="Green packaged uni-color socks">
                        ...
                        <div class="grid-items4 flex-element">
                            <div class="rec">
                                <a  href="./product_detail_strip.php" ><img class="rec-img pack-sock-yellow"  src="./img/packaging/png/catalogus_sokken_stripes_yellow.png" alt="Yellow packaged uni-color socks">
