...
<html lang="en">
    ...
    <main>
        ...
        <p><a href="Project1.php"> Home &nbsp; > &nbsp;<b>Uni-Color Socks</b></a></p>
                ...
                <section class ="color-container">
                    ...
                    <div id="submit-and-counter">
                        ...
                        <div id="redCountFields" style="display:none">
                            ...
                            <input type="number" class="number-input" name="counts_of_pairs[red-u]" min="0">
                        </div>
                        <div id="greenCountFields" style="display:none">
                            <label for="field-green">Pair count:</label>
                            <input type="number" class="number-input" name="counts_of_pairs[green-u]" min="0">
                        </div>
                        <div id="blueCountFields" style="display:block">
                            <label for="field-blue">Pair count:</label>
                            <input type="number" class="number-input" name="counts_of_pairs[blue-u]" min="0">
                        </div>
                        <div id="yellowCountFields" style="display:none">
                            <label for="field-yellow">Pair count:</label>
                            <input type="number" class="number-input" name="counts_of_pairs[yellow-u]" min="0">
                        </div>
                        <div id="pinkCountFields" style="display:none">
                            <label for="field-pink">Pair count:</label>
                            <input type="number" class="number-input" name="counts_of_pairs[pink-u]" min="0">
                        </div>
                        <!-- Go to the cart -->
                ...
                <div class ="recommend-section">
                        ...
                        <div class="rec-h1-style"><h1> You might also like</h1></div>
                            ...
                            <div class="grid-items1 flex-element">
                                <div class="rec">
                                <a  href="./product_detail_strip.php"> <img class="rec-img pack-sock-blue" src="./img/packaging/png/catalogus_sokken_stripes_blue.png" alt="Blue packaged stripes socks">
                            ...
                            <div class="grid-items2 flex-element">
                                <div class="rec">
                                <a  href="./product_detail_strip.php"><img class="rec-img pack-sock-pink" src="./img/packaging/png/catalogus_sokken_stripes_pink.png" alt="Pink packaged stripes socks">
                            ...
                            <div class="grid-items3 flex-element">
                                <div class="rec">
                                <a  href="./product_detail_strip.php" ><img class="rec-img pack-sock-green" src="./img/packaging/png/catalogus_sokken_stripes_green.png" alt="Green packaged stripes socks">
                                    <p>Sunny's Green Strip Sock</p></a>
                                        <span class="fa fa-star checked"></span>
                                        <span class="fa fa-star checked"></span>
                                        <span class="fa fa-star checked"></span>
                                        <span class="fa fa-star checked"></span>
                            ...
                            <div class="grid-items4 flex-element">
                                <div class="rec">
                                <a  href="./product_detail_strip.php" ><img class="rec-img pack-sock-yellow" src="./img/packaging/png/catalogus_sokken_stripes_yellow.png" alt="Yellow stripes socks">
                                    <p>Sunny's Yellow Strip Sock</p></a>
                                        <span class="fa fa-star checked"></span>
                                        <span class="fa fa-star checked"></span>
                                        <span class="fa fa-star checked"></span>
                                    <p>&euro;3.99</p>
